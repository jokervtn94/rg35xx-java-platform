...
# A8 is packaging only. Refuse any rebuilt runtime that differs from the exact
# A7+A1P5 device-pass identities recovered from the accepted device package.
test "$(sha256sum "$SRC/freej2me-rg35xx.jar"|awk '{print $1}')" = 057567d454ac94d4d1d08ad8fc84ef22515c00418d28057aa70e74b4042d336c || fail PLATFORM_IDENTITY
...
057567d454ac94d4d1d08ad8fc84ef22515c00418d28057aa70e74b4042d336c  freej2me-rg35xx.jar
