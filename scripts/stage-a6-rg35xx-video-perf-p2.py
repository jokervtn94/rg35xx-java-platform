...
if body.count('SDL_MapRGB_p(screen->format') != 1:
    raise SystemExit('A6_PERF_P2_STAGE_FAIL expected exactly one runtime fallback MapRGB call, got %d' % body.count('SDL_MapRGB_p(screen->format'))
