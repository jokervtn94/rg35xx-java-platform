...
test -f "$ROOT/project-rules/RG35XX_PROJECT_RULES.json"
test -f "$ROOT/tasklog/R2.3-HANG-LOCALIZATION-AB-PREFLIGHT.md"
...
FZ_UPSTREAM="$UP" FZ_ASSEMBLY="$R23" sh "$ROOT/scripts/from_zero_assemble_v1.sh"
python3 "$ROOT/scripts/from_zero_apply_nomask_ab.py" "$R23/src/org/recompile/mobile/PlatformGraphics.java"
python3 "$ROOT/scripts/vc7_apply_golden_font.py" "$R23/src/org/recompile/mobile/PlatformGraphics.java"
...
python3 "$ROOT/scripts/vc7r_reconstruct_font.py" --font "$LATIN" --font "$CJK#0" --out "$RUNNER_TEMP/r23-font/rg35xx-font.bin" --manifest "$RUNNER_TEMP/r23-font/manifest.json"
...
python3 "$ROOT/scripts/vc7r3_apply_native_audio.py" "$R23/src/libretro/freej2me_libretro.c"
python3 "$ROOT/scripts/vc7r3_apply_java_media_events.py" "$R23/src/org/recompile/freej2me/Libretro.java" "$R23/src/org/recompile/mobile/PlatformPlayer.java" "$R23/src/javax/microedition/media/Manager.java"
python3 "$ROOT/scripts/vc7r22r1_apply_worker_ring.py" "$R23/src/libretro/freej2me_libretro.c"
python3 "$ROOT/scripts/vc7r22r2_apply_golden_tsf.py" "$R23/src/libretro/rg35xx/rg35xx_tsf_worker.c" "$R23/src/libretro/freej2me_libretro.c"
...
python3 "$ROOT/scripts/vc7r22r22_apply_filebacked_midi.py" "$R23/src/org/recompile/mobile/RG35XXNativePlayer.java" "$R23/src/org/recompile/mobile/RG35XXAudioTransport.java" "$R23/src/org/recompile/mobile/RG35XXAudioProtocol.java" "$R23/src/libretro/rg35xx/rg35xx_audio_protocol.h" "$R23/src/libretro/rg35xx/rg35xx_audio_dispatch.c"
(cd "$R23" && ant >/dev/null)
...
python3 "$ROOT/scripts/vc7r22r23_apply_hang_localization.py" "$R23/src/libretro/freej2me_libretro.c" "$R23/src/libretro/rg35xx/golden/rg35xx_golden_video.c"
...
python3 "$ROOT/scripts/vc7r22r21_apply_prime2048_ab.py" "$R23/src/libretro/freej2me_libretro.c"
build_core
...
cp "$ROOT/installer/INSTALL-AUDIO-R2.3-HANG-LOCALIZATION-AB.ps1" "$ROOT/installer/INSTALL-AUDIO-R2.3-HANG-LOCALIZATION-AB.cmd" "$OUT/installer/"
cp "$ROOT/tasklog/R2.3-HANG-LOCALIZATION-AB-PREFLIGHT.md" "$OUT/evidence/"
