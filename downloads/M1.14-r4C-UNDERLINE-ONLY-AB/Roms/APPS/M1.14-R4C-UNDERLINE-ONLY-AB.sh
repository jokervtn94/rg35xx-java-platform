...
rm -f "$SHOT" "$META"; : >"$OUT"
echo 'RG35XX M1.14-r4C UNDERLINE ONLY AB' >>"$OUT"; echo M1_14_R4C_PRIMARY_VARIABLE=UNDERLINE_RASTER_ONLY >>"$OUT"; echo M1_14_R4A_BOLD_BASELINE=PRESERVED_DEVICE_PASS >>"$OUT"; echo M1_14_R4B_ITALIC_BASELINE=PRESERVED_DEVICE_PASS >>"$OUT"; echo M1_14_RESOURCE_CLASSIFICATION=EXPERIMENTAL_NOT_GOLDEN >>"$OUT"
