...
- First build toolchain source: `MiyooCFW/buildroot@8087b52311da5c1e2fa1c50b0b064c07fd174a36`, configuration `configs/miyoo_uclibc_defconfig`, Git blob `58256d3e7afa3f9fa0dbd79b16fd0b21d93b9d7b`. 011S owns acquisition through `scripts/rc1_toolchain_acquire.sh` and requires the resulting SDK to contain prefix `arm-miyoo-linux-uclibcgnueabi`. The old MiyooCFW toolchain v2.0.0 binary release is not accepted because that release is musl, not uClibc.
