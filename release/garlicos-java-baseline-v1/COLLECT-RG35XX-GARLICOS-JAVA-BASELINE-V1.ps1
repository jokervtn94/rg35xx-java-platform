...
$out=Join-Path $PSScriptRoot ("RG35XX-GARLICOS-JAVA-EVIDENCE-"+$stamp); New-Item -ItemType Directory -Force -Path $out|Out-Null
foreach($n in @('RG35XX-GARLICOS-JAVA-BASELINE-V1-INSTALL-RESULT.txt','freej2me-vc3-early.log','freej2me-core.log','freej2me-java-error.log','freej2me-java-control.log')){
