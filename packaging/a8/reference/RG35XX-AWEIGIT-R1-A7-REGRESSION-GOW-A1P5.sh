#!/bin/sh
OUT=/mnt/mmc/RG35XX-AWEIGIT-R1-A7-REGRESSION-GOW-A1P5-RESULT.txt
...
GAME="$PKG/God-of-War-Betrayal_J2ME_EN_v148.jar"
...
echo 'GAME_KEY=GOD_OF_WAR_BETRAYAL' >>"$OUT"
echo 'GAME_FILE=God-of-War-Betrayal_J2ME_EN_v148.jar' >>"$OUT"
echo 'GAME_SHA256_EXPECTED=e256ca47cde2b27735a4f4d3d826003ac5bbc723f91629bd5d093d948c1f9a98' >>"$OUT"
